...
--
CREATE DATABASE  IF NOT EXISTS `dpto_punto_com`;
USE `dpto_punto_com`;
...
CREATE TABLE `publicacion` (
  ...
  KEY `fk_id_usr_idx` (`id_usuario`),
  CONSTRAINT `fk_id_usr` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`),
...
-- Dump completed on 2021-11-20 15:04:59
